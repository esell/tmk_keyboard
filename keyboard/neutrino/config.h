...
#define MANUFACTURER    esHeavyIndustries
#define PRODUCT         es01 w/ Bluetooth
#define DESCRIPTION     es01 Keyboard w/ Bluetooth


/* matrix size */
#define MATRIX_ROWS 5  // keycode bit: 3-0
#define MATRIX_COLS 15   // keycode bit: 6-4
